...
const Index = () => {
  ...
  return (
    <Layout noFooter noHeader bodyClass={"main"}>
      <Header1 />
      <section className="tf-slider-1 esraaHi">
      ...
      <section className="tf-section tf-sc-blog2">
        ...
        />
        <img
          className="feature-blog-2"
          src="assets/images/patternphoto/feauture-blog-2.png"
          alt="Image"
        />
        <img
          className="feature-blog-3"
          src="assets/images/patternphoto/feauture-blog-3.png"
          alt="Image"
        />
        <img
          className="feature-blog-4"
          src="assets/images/patternphoto/feauture-blog-4.png"
          alt="Image"
        />
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-4 col-md-4 col-12">
              <div
                className="sc-artice wow fadeIn animated"
                data-wow-delay="0.3ms"
                data-wow-duration="1200ms"
              >
                <div className="box-feature fx">
                  <Link href="/blog-single">
                    <a>
                      <img
                        src="assets/images/common/sc-article-1.jpg"
                        alt="Image"
                      />
                    </a>
                  </Link>
                ...
                <div className="box-content">
                  <div className="meta-post">
                    <ul className="fx">
                      <li>
                        <a href="#" className="fx clr-pri-5">
                          <i className="far fa-calendar-alt clr-pri-5" />
                          25 Dec 2021
                        </a>
                      </li>
                      <li>
                        <a href="#" className="fx clr-pri-5">
                          <i className="far fa-comment-alt-dots clr-pri-5" />
                          Com (05)
                        </a>
                      </li>
                    </ul>
                  ...
                  <h4 className="title-article-post">
                    <Link href="/blog-single">
                      <a>Useful VS Code Extensions Front End Developer</a>
                    </Link>
                  </h4>
                  <p className="wrap f-mulish">
                    Sit amet consectetur adipiscing sedey eiusmod tempor
                    incididunt
                  </p>
              ...
              >
                <div className="box-feature fx">
                  <Link href="/blog-single">
                    <a>
                      <img
                        src="assets/images/common/sc-article-2.jpg"
                        alt="Image"
                      />
                    </a>
                  </Link>
              ...
              >
                <div className="box-feature fx">
                  <Link href="/blog-single">
                    <a>
                      <img
                        src="assets/images/common/sc-article-3.jpg"
                        alt="Image"
                      />
                    </a>
                  </Link>
