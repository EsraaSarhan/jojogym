...
const Footer = () => {
  return (
    <footer id="footer">
      <section className="tf-subcribe d-none" >
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-12 col-12">
              <div className="subcribe-wp">
                <h2 className="title">Subscribe Our Newsletter esraaHi test</h2>
          ...
          <div className="row">
            ...
            <div className="col-12">
              <div className="footer-bottom jus-ct">
                 <p className="copy-right"> حقوق النشر محفوظة © {new Date().getFullYear()}</p>
