        ...
        >
          <ul className="menu" id="mainnav">
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu" style={activeLi("PAGES")}>
                ...
                <li className="inner-menu-item ">
                  ...
                  <span
                    className="btn-submenu"
                    onClick={() => setSub("Customers", "PAGES")}
                  />
                  <ul className="sub-menu" style={activeSub("Customers")}>
                    <Customers />
                  </ul>
                </li>
                <li className="inner-menu-item">
            ...
            <li className="menu-item-has-children">
              <a>NewCustomer</a>
              <span
                className={`btn-submenu ${activeBtn("NewCustomer")}`}
                onClick={() => activeMenuSet("NewCustomer")}
              />
              <ul className="sub-menu" style={activeLi("NewCustomer")}>
                <NewCustomer />
              </ul>
            </li>
            <li className="inner">
